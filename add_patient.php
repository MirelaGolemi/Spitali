      ...
      <h3>Enter Information</h3>
                <?php
                  if(isset($_POST['apfullname'])){
                    ...
                    appointment_booking($i, $_POST['apSpecialist'], $_POST['apCondition'] , $_POST['apPayment']);
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label for="pwd">Payment (Euro):</label>
              <input type="number" class="form-control" id="payment" name="apPayment" min="100" max="900" required>
            </div>
