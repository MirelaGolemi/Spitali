...
<?php
    ...
    $connection = new mysqli('localhost', 'root', '', 'spitali_db');
  ...
  function enter_patient_info($full_name_unsafe, $age_unsafe, $weight_unsafe, $phone_no_unsafe, $address_unsafe)
  {
    ...
    function appointment_booking($patient_id_unsafe, $specialist_unsafe, $medical_condition_unsafe,$payment_amount_unsafe)
    {
        global $connection;
        ...
        $sql = "INSERT INTO appointments VALUES (NULL, $patient_id, '$specialist', '$medical_condition', '$payment_amount', 'no')";
